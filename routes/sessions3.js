...
const Session = require("../models/Sessions3");
const Client = require("../models/Clients3");
...
router.post("/addSession_old", upload.array("files[]"), async (req, res) => {
  ...
  try {
    ...
    await axios({
      method: "post",
      url: "https://device3api.el.r.appspot.com/api/newSession",
...
router.post("/storeTutorResponse", async (req, res) => {
  ...
  try {
    ...
    await axios({
      method: "post",
      url: "https://device3api.el.r.appspot.com/api/interestedTutors",
...
router.post("/tutorEmailNotification", async (req, res) => {
  try {
    ...
    let transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "tutorpointdevice3@gmail.com",
        pass: "tcilmuohlxnmjrpf",
      },
    });

    let mailOptions = {
      from: "tutorpointdevice3@gmail.com",
      to: req.body.email,
